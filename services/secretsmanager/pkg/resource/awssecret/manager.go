...
// +kubebuilder:rbac:groups=secretsmanager.services.k8s.aws,resources=awssecrets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=secretsmanager.services.k8s.aws,resources=awssecrets/status,verbs=get;update;patch
