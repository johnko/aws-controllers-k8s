...
const (
	finalizerString = "finalizers.secretsmanager.services.k8s.aws/AWSSecret"
)
...
func (d *resourceDescriptor) Diff(
	...
	opts := []cmp.Option{
		...
		cmp.AllowUnexported(svcapitypes.AWSSecret{}),
	}
